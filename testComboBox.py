...
class EditItemDlg(QDialog):
    def __init__(self, parent=None):
        ...
        self.locusTypeComboBox = self.createCombobox(self.locusTypeModel, "LABEL")
        ...
        # Create combo and set its model
        self.locusSubTypeCombobox = self.createCombobox(self.locusSubTypeModel, "label")
        #
    ...
    def f(self, index):
        locusTypeModelIndex = self.locusTypeModel.index(index, self.locusTypeModel.fieldIndex("ID"))
        ...
        filter = QString("locusTypeID=%1").arg(data.toPyObject())
